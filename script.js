document.addEventListener('DOMContentLoaded', () => {
    ...
    commonReportBtn.addEventListener('click', () => {
        ...
        const latLonPairs = [
            ...
            {lat: 43.2220, lon: 140.9780 }, // 小樽運河 (北海道)
            {lat: 40.8248, lon: 140.7400 }, // 弘前城 (青森)
            {lat: 38.1393, lon: 140.8893 }, // 松島 (宮城)
            {lat: 37.7503, lon: 140.4675 }, // 磐梯山 (福島)
            {lat: 36.6514, lon: 138.1811 }, // 善光寺 (長野)
            {lat: 36.2048, lon: 137.7940 }, // 上高地 (長野)
            {lat: 35.1564, lon: 136.9260 }, // 熱田神宮 (名古屋)
            {lat: 34.8101, lon: 137.3235 }, // 浜松城 (静岡)
            {lat: 34.6069, lon: 138.2102 }, // 下田海中水族館 (静岡)
            {lat: 34.6864, lon: 135.5197 }, // 天王寺動物園 (大阪)
            {lat: 34.6937, lon: 135.4834 }, // 道頓堀 (大阪)
            {lat: 34.6851, lon: 135.8050 }, // 東大寺 (奈良)
            {lat: 34.3964, lon: 132.4594 }, // 原爆ドーム (広島)
            {lat: 32.7898, lon: 129.8652 }, // グラバー園 (長崎)
            {lat: 31.5966, lon: 130.5571 }, // 桜島 (鹿児島)
            {lat: 26.3344, lon: 127.8056 }, // 美ら海水族館 (沖縄)
            {lat: 27.0346, lon: 142.2053 }, // 父島 (小笠原諸島)
            {lat: 39.7198, lon: 140.1035 }, // 田沢湖 (秋田)
            {lat: 41.3335, lon: 141.0708 }, // 八甲田山 (青森)
            {lat: 33.1396, lon: 129.7331 }, // 五島列島 (長崎)
            {lat: 28.3780, lon: 129.4968 }, // 奄美大島 (鹿児島)
            {lat: 36.5626, lon: 136.6569 }, // 兼六園 (石川)
            {lat: 34.9177, lon: 138.3242 }, // 富士サファリパーク (静岡)
            {lat: 35.6916, lon: 139.7006 }, // 渋谷スクランブル (東京)
            {lat: 35.6938, lon: 139.7036 }, // 明治神宮 (東京)
            {lat: 33.5904, lon: 130.4017 }, // 福岡大濠公園 (福岡)
            {lat: 34.8274, lon: 134.6875 }, // 姫路城 (兵庫)
            {lat: 34.7100, lon: 135.4936 }, // 海遊館 (大阪)
            {lat: 35.0116, lon: 135.7681 }, // 清水寺 (京都)
            {lat: 34.7946, lon: 135.5382 }, // 甲子園球場 (兵庫)
            {lat: 32.7502, lon: 129.8777 }, // 長崎平和公園 (長崎)
            {lat: 33.6064, lon: 130.4180 }, // 北九州市小倉城 (福岡)
            {lat: 34.6873, lon: 135.5259 }, // 大阪城 (大阪)
            {lat: 34.2275, lon: 135.1675 }, // 和歌山城 (和歌山)
            {lat: 33.8395, lon: 132.7658 }, // 松山城 (愛媛)
            {lat: 36.6913, lon: 138.1858 }, // 白馬村 (長野)
            {lat: 43.0687, lon: 141.3508 }, // 札幌時計台 (北海道)
            {lat: 34.8020, lon: 135.4306 }, // ユニバーサルスタジオジャパン (大阪)
            {lat: 36.1006, lon: 136.2235 }, // 東尋坊 (福井)
            {lat: 34.6851, lon: 135.8050 }, // 興福寺 (奈良)
            {lat: 31.9111, lon: 131.4239 }, // 宮崎神宮 (宮崎)
            {lat: 38.2689, lon: 140.8719 }  // 瑞鳳殿 (宮城)
        ];
